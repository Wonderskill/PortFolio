...
public class PetManager : MonoBehaviour
{
    ...
    public GameObject panel_main; // 메인 UI Panel
    public GameObject panel_joystick; // 조이스틱 UI Panel
    ...
    public void Select_Dog()
    {
        ...
        if (PhotonNetwork.InRoom)
        {
            ...
            panel_main.SetActive(true); // 도움말 UI 활성화
            panel_joystick.SetActive(true); // 조이스틱 UI 활성화
            panel_pet.SetActive(false); // 펫 선택 UI 비활성화
            select_pet = true;
            NodeMain.SelectedPet = "Dog";
